...
function Cart() {
   ...
   return (
      ...
      <div className="yourCart top-content"style={{display: 'none',}}>
         <a href="/" className="buymore">Mua thêm sản phẩm khác</a>
         <span>Giỏ hàng của anh </span>
      </div>
      <div className="middleCart"style={{display: 'none',}}>
                        ...
                        <ul>
                           <li>
                              ...
                              <a href="/dtdd/iphone-13-pro-max-256gb" className="img-order">
                                 <img alt='' data-src="" src="" width="40px" height="auto" loading="lazy" className="lazyload" />
                              </a>
